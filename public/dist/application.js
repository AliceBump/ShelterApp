...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('customers', ['ui.bootstrap']);
...
angular.module('core')
    .factory('sitterFactory', ["$http", function($http) {
      function getSitters() {
  ...
  function($scope, $stateParams, Authentication, Customers, $uibModal, $log) {
    ...
    this.modalUpdate = function (size, selectedCustomer) {
      ...
      var modalInstance = $uibModal.open({
        ...
        controller: ["$scope", "$uibModalInstance", "aCustomer", function ($scope, $uibModalInstance, aCustomer) {
